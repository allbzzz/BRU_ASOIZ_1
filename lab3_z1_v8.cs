/*
Лабораторная 3, задание 1, вариант 8
Написать программу, которая, реализует диалог с
пользователем:
запрашивает с клавиат
уры сумму
...
class Program
{
    static void Main() {
        ...
        Console.WriteLine($"Итоговая сумма вклада без капитализации: {totalAmount:F2} " +
            $"(начальный вклад: {depositAmount:F2}, начисленные проценты: {interestAmount:F2})");
    }
}